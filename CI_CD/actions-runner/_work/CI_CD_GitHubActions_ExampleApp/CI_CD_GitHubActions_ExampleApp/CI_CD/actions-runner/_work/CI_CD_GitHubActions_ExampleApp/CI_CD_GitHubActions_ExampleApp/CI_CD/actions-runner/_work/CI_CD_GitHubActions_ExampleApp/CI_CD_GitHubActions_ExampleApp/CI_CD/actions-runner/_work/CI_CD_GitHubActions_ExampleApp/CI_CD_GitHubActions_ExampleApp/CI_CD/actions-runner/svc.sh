...
SVC_NAME="actions.runner.SiemensIndustrialEdgeITA-CI_CD_GitHubActions_.devvm.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (SiemensIndustrialEdgeITA-CI_CD_GitHubActions_ExampleApp.devvm)"
